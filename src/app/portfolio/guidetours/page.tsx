...
export default function GuideToursPage() {
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal>
              ...
              <h1 className="font-serif text-[clamp(42px,7vw,64px)] font-semibold leading-[0.95] tracking-tight text-foreground mb-6">GuideTours</h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button href="#demo" size="lg" className="bg-foreground text-background hover:bg-foreground/90">
                  Book a Demo
                ...
                <div className="relative bg-background rounded-2xl border border-grey-200 dark:border-grey-800 shadow-2xl overflow-hidden card-elevated">
                  ...
                  <div className="p-6">
                    ...
                    <div className="bg-grey-100 dark:bg-grey-800 rounded-lg p-4 mb-4">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between p-2 bg-white dark:bg-grey-700 rounded">
                          <span className="text-[11px] font-semibold text-foreground">Sagrada Familia Tour</span>
                        ...
                        <div className="flex items-center justify-between p-2 bg-white dark:bg-grey-700 rounded">
                          <span className="text-[11px] font-semibold text-foreground">Park Güell Walk</span>
                    ...
                    <div className="flex items-center justify-between p-3 bg-purple-500/10 border border-purple-500/20 rounded-lg">
                      <div>
                        <div className="text-[13px] font-bold text-foreground">Platform Sync</div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <ScrollReveal>
            <div className="text-center mb-16">
              ...
              <h2 className="font-serif text-[clamp(36px,5vw,56px)] font-semibold leading-[1.08] tracking-tight text-foreground">Connect everywhere</h2>
            ...
            {integrations.map((integration, index) => (
              <ScrollReveal key={integration.name} delay={index * 50}>
                <div className="p-6 border border-foreground/10 hover:border-foreground/30 rounded-lg transition-all text-center">
                  <div className="w-16 h-16 rounded-xl bg-foreground text-background flex items-center justify-center mx-auto mb-4">
                    <integration.icon className="w-8 h-8" strokeWidth={1.5} />
                  </div>
                  <h3 className="text-[16px] font-bold text-foreground mb-2">{integration.name}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <ScrollReveal delay={100}>
              <div className="relative scale-105 p-6 sm:p-8 border border-foreground/20 rounded-lg transition-all shadow-xl shadow-purple-500/20">
                ...
                <div className="text-[42px] font-serif font-bold text-foreground mb-2">€159<span className="text-[16px] font-sans text-grey-500">/mo</span></div>
                ...
                <Button href="#demo" className="w-full bg-foreground text-background hover:bg-foreground/90">
                  Book Demo
                </Button>
              </div>
            </ScrollReveal>
      ...
      {/* CTA Section */}
      <section id="demo" className="relative py-32 overflow-hidden bg-grey-900 dark:bg-grey-50 text-white dark:text-grey-900">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 md:px-12 text-center">
          <ScrollReveal>
            ...
            <p className="text-[18px] text-grey-300 dark:text-grey-600 leading-relaxed mb-10 max-w-2xl mx-auto">Book a personalized demo. See how GuideTours can save you 8+ hours per week and increase your bookings by 20%.</p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button href="/#contact" size="lg" className="bg-white text-grey-900 hover:bg-white/90">
                Book Your Demo
                <ArrowRight className="w-4 h-4" />
              </Button>
              <Link href="/portfolio" className="inline-flex items-center justify-center gap-2 text-[14px] font-semibold no-underline px-6 py-3 rounded-lg border border-white/20 dark:border-black/20 text-white dark:text-grey-900 hover:bg-white/10 dark:hover:bg-black/5 transition-all">Back to Portfolio</Link>
            </div>
          </ScrollReveal>
        </div>
      </section>
