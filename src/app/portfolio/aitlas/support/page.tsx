        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-12 text-center">
          ...
          <ScrollReveal>
            ...
            <p className="text-[20px] sm:text-[24px] leading-[1.6] text-grey-500 max-w-2xl mx-auto mb-8">
              AI-powered helpdesk that resolves tickets autonomously. No more templated responses — actual solutions.
            </p>
        ...
        <div className="max-w-3xl mx-auto px-6">
          <ScrollReveal>
            ...
            <p className="text-[16px] text-grey-500 mb-10 max-w-lg mx-auto">
              Join the waitlist for f.support — autonomous helpdesk that actually helps.
            </p>
