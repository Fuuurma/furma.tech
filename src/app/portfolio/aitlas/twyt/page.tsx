          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <ScrollReveal delay={200}>
              <div className="relative py-20 lg:py-32">
                <Card className="bg-background border-grey-200 dark:border-grey-800 shadow-2xl overflow-hidden rotate-1">
        ...
        <Container size="full">
          ...
          <StaggerChildren className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {useCases.map((useCase) => (
              <Card key={useCase.title} className="bg-background text-center p-6 sm:p-8 hover:border-foreground/30 hover:shadow-2xl hover:shadow-foreground/5 transition-all duration-500">
