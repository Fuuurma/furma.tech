      ...
      <section id="actions" className="py-32 bg-grey-50 border-y border-border dark:bg-grey-900/20">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <StaggerChildren className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-px bg-border border border-border">
            {actions.map((action) => (
              <Link key={action.name} href={`/projects/aitlas/${action.name.replace("f.", "")}`} className="block group bg-background hover:bg-foreground hover:text-background transition-colors duration-500 no-underline">
