        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 md:px-12 text-center">
          <ScrollReveal>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-background/10 border border-background/20 mb-10 backdrop-blur-sm">
              ...
              <span className="font-mono text-[11px] font-bold tracking-[0.12em] uppercase text-background/70">Free to start</span>
            </div>
            
            <h2 className="font-serif text-[clamp(36px,5vw,64px)] font-semibold leading-[1] tracking-tight text-background mb-8">Ready to own your AI?</h2>
