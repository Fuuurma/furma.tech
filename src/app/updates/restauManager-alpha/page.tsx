      ...
      <section className="section">
        <div className="px-6 md:px-12 max-w-3xl">
          ...
          <div className="prose prose-lg text-grey-600">
            ...
            <h2 className="font-serif text-[28px] font-semibold text-fg mt-12 mb-4">What We Learned</h2>
            <p className="text-[17px] leading-[1.8] mb-6">
            ...
            <h2 className="font-serif text-[28px] font-semibold text-fg mt-12 mb-4">What Worked</h2>
            <ul className="space-y-3 mb-6">
              <li><strong className="text-fg">Floor plan editor</strong> — Intuitive enough that no training was needed</li>
              <li><strong className="text-fg">TheFork sync</strong> — Bookings appear in real-time, no more double-bookings</li>
              <li><strong className="text-fg">Mobile view</strong> — Staff loved being able to see the floor plan on phones</li>
            </ul>

            <h2 className="font-serif text-[28px] font-semibold text-fg mt-12 mb-4">What Needs Work</h2>
            <p className="text-[17px] leading-[1.8] mb-6">
            ...
            <h2 className="font-serif text-[28px] font-semibold text-fg mt-12 mb-4">Next Steps</h2>
