      ...
      <Section variant="default" className="py-24">
        <Container size="sm">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <h2 className="text-[28px] font-bold text-foreground mt-12 mb-6">The VC Math Doesn&apos;t Work for Us</h2>
            <p className="text-[17px] leading-[1.8] mb-6">
            ...
            <h2 className="text-[28px] font-bold text-foreground mt-12 mb-6">Control Matters More Than Capital</h2>
            <p className="text-[17px] leading-[1.8] mb-6">
            ...
            <h2 className="text-[28px] font-bold text-foreground mt-12 mb-6">Sustainable &gt; Unstoppable</h2>
            <p className="text-[17px] leading-[1.8] mb-6">
