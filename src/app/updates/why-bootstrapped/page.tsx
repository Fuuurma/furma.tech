      ...
      <section className="section">
        <div className="px-6 md:px-12 max-w-3xl">
          ...
          <div className="prose prose-lg text-grey-600">
            ...
            <h2 className="font-serif text-[28px] font-semibold text-fg mt-12 mb-4">The VC Math Doesn&apos;t Work for Us</h2>
            <p className="text-[17px] leading-[1.8] mb-6">
            ...
            <h2 className="font-serif text-[28px] font-semibold text-fg mt-12 mb-4">Control Matters More Than Capital</h2>
            <p className="text-[17px] leading-[1.8] mb-6">
            ...
            <h2 className="font-serif text-[28px] font-semibold text-fg mt-12 mb-4">Sustainable &gt; Unstoppable</h2>
            <p className="text-[17px] leading-[1.8] mb-6">
