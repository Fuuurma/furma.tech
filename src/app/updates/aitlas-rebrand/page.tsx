        ...
        <div className="px-6 md:px-12 max-w-3xl">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-4">
              <span className="font-mono text-[10px] uppercase tracking-wider px-2 py-1 rounded bg-fg/10 text-fg">
                Product
              </span>
          ...
          <div className="prose prose-lg text-grey-600">
            ...
            <h2 className="font-serif text-[28px] font-semibold text-fg mt-12 mb-4">What Changed</h2>
            <ul className="space-y-3 mb-6">
              <li><strong className="text-fg">Nexus</strong> is now <strong className="text-fg">Nova</strong> — our AI workspace where users bring their own keys and chat with agents</li>
              <li><strong className="text-fg">f.loop</strong> is now <strong className="text-fg">Nexus runtime</strong> — the durable execution engine behind the scenes</li>
              <li><strong className="text-fg">f.xyz Actions</strong> remain the same — our suite of MCP-powered micro-tools</li>
            </ul>

            <h2 className="font-serif text-[28px] font-semibold text-fg mt-12 mb-4">Why the Change</h2>
            <p className="text-[17px] leading-[1.8] mb-6">
            ...
            <h2 className="font-serif text-[28px] font-semibold text-fg mt-12 mb-4">What This Means for You</h2>
            <p className="text-[17px] leading-[1.8] mb-6">
