      ...
      <Section variant="default" className="py-24">
        <Container size="sm">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <h2 className="text-[28px] font-bold text-foreground mt-12 mb-6">What is MCP?</h2>
            <p className="text-[17px] leading-[1.8] mb-6">
            ...
            <h2 className="text-[28px] font-bold text-foreground mt-12 mb-6">Why We Built on MCP</h2>
            <p className="text-[17px] leading-[1.8] mb-6">
            ...
            <ul className="space-y-4 mb-6 list-none pl-0">
              <li className="flex gap-4">
                ...
                <span><strong className="text-foreground">Composability</strong> — Mix and match tools from different providers</span>
              </li>
              <li className="flex gap-4">
                <span className="text-amber-600 font-mono font-bold">→</span>
                <span><strong className="text-foreground">Standardization</strong> — One integration works across all MCP clients</span>
              </li>
              <li className="flex gap-4">
                <span className="text-amber-600 font-mono font-bold">→</span>
                <span><strong className="text-foreground">Future-proofing</strong> — New tools automatically work with existing integrations</span>
              </li>
            </ul>

            <h2 className="text-[28px] font-bold text-foreground mt-12 mb-6">The Aitlas Stack</h2>
            <p className="text-[17px] leading-[1.8] mb-6">
            ...
            <h2 className="text-[28px] font-bold text-foreground mt-12 mb-6">The Future is Interoperable</h2>
            ...
            <Button href="/portfolio/aitlas" variant="premium">Discover Aitlas →</Button>
          </div>
        </Container>
      </Section>
    </div>
