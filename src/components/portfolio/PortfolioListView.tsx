...
export function PortfolioListView() {
  return (
    <div className="portfolio-list-page">
      ...
      <section className="portfolio-list-page__intro">
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-12 md:col-span-8 md:col-start-4 lg:col-start-5">
              ...
              <ScrollReveal delay={280}>
                <p className="plastic-paragraph text-foreground/60 max-w-lg mt-4">
                  Bootstrapped from Sitges. 0% VC. Hover a project to preview, or
                  select to open.
                </p>
              </ScrollReveal>
            </div>
      ...
      <section className="portfolio-list-page__list" aria-label="Projects">
      ...
      <section className="portfolio-list-page__outro border-t border-foreground/10 bg-background">
            ...
            <div className="col-span-12 md:col-span-8 md:col-start-4 lg:col-start-5">
              ...
              <ScrollReveal delay={220}>
                <div className="flex flex-wrap gap-6">
                  ...
                  <Link href="/" className="plastic-label hover:text-foreground motion-link-subtle">
                    Back to home
                  </Link>
                </div>
              </ScrollReveal>
